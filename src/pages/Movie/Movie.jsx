...
import {Container, Content, Profile, Title}  from './styles.js';
        ...
        <Content> 
          <Section>
            ...
            <Profile to="/profile">
              ...
              />
              <div>        
                <pre>Por Dyonathan Cox  <FiClock /> 12/03/2025 às 08:00</pre>
              </div>
            </Profile>
            <Note style={{background: "transparent", padding:"0"}} data={{
              tags: [
            ...
            <p>
              ...
              se mostrar habitável, a humanidade irá seguir para ele na instalação da NASA, que é na 
              realidade uma enorme estação espacial. A partida de Cooper devasta Murphy.
